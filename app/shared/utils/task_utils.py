...
_NODE_NAME_TO_CN: Dict[str, str] = {
    ...
    "node_pptx_to_md": "PPT转Markdown",
    "node_xlsx_to_md": "Excel转Markdown",
    "node_image_ocr": "图片OCR识别",
    "node_html_to_md": "HTML转Markdown",
    "node_txt_to_md": "文本转Markdown",
    ...
    "__end__": "处理完成",
    "END": "处理完成",
    # --- Query 流程节点（kb/rag/query/main_graph.py）---
